        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="w-full">
                <div class="bg-white shadow rounded-xl p-6">
                    <h3 class="text-xl font-semibold mb-4">Nationality List</h3>
                    <a href="{{route('nationalities.create')}}">Create</a>
                    {{ $nationalities->links() }}
                    <table class="w-full min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                <th class="text-left text-sm font-medium text-gray-700 px-4 py-2">SL</th>
                                <th class="text-left text-sm font-medium text-gray-700 px-4 py-2">Nationality</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($nationalities as $key => $nationality)
                                <tr>
                                    ...
                                    <td class="px-4 py-2 text-sm text-gray-800">{{ $nationality->name }}</td>
                                    <td class="px-4 py-2">
