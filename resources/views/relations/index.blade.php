        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="w-full">
                <div class="bg-white shadow rounded-xl p-6">
                    <h3 class="text-xl font-semibold mb-4">Occupations List</h3>
                    <a href="{{route('relations.create')}}">Create</a>
                    {{ $relations->links() }}
                    <table class="w-full min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                <th class="text-left text-sm font-medium text-gray-700 px-4 py-2">SL</th>
                                <th class="text-left text-sm font-medium text-gray-700 px-4 py-2">Relations</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($relations as $key => $relation)
                                <tr>
                                    ...
                                    <td class="px-4 py-2 text-sm text-gray-800">{{ $relation->name }}</td>
                                    <td class="px-4 py-2">
