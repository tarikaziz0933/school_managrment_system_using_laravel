            ...
            <div class="w-full">
                <div class="bg-white shadow-xl rounded-2xl p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-2xl font-semibold text-gray-800">Roles</h3>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @foreach ($roles as $key => $role)
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-4 py-3 text-sm text-gray-800">{{ $role->name }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-800">{{ $role->display_name }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-800">{{ $role->description }}</td>
