    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="lg:w-1/2 w-full mx-auto">
            <div class="bg-white shadow-lg rounded-xl p-6">
                ...
                @endif
                <h3 class="text-2xl font-semibold mb-6 text-center text-gray-800">Create <span class="text-blue-600">Occupation</span></h3>
                <form action="{{ route('occupations.store') }}" method="POST">
                    @csrf

                    @include('setups.occupations.input_fields', ['occupation' => null])
