    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="lg:w-1/3 w-full mx-auto">
            <div class="bg-white shadow-lg rounded-xl p-6">
                ...
                @endif
                <h3 class="text-xl font-semibold mb-4 text-center text-gray-800">Edit <span
                        class="text-blue-600">Nationality</span></h3>
                <form action="{{ route('nationalities.update',  $nationality->id) }}" method="POST">
                    @csrf
                    @method('PUT')

                    @include('setups.nationalities.input_fields', ['nationality' => $nationality])
