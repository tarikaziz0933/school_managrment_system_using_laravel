    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="lg:w-1/2 w-full mx-auto">
            <div class="bg-white shadow-lg rounded-xl p-6">
                ...
                <h3 class="text-2xl font-semibold mb-6 text-center text-gray-800">Edit <span class="text-blue-600">Exam Name</span></h3>
                <form action="{{ route('exams.update', $exam->id) }}" method="POST">
                    @csrf
                    @method('PUT')

                    @include('setups.exam_names.input_fields', ['exam' => $exam])
