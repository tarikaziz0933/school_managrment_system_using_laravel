<x-app-layout>
    <x-page-layout :title="'Employment Type: Edit'">
        ...
        <div class=" mx-auto px-4 py-8">
            ...
            <div class="w-full mx-auto">
                <div class="rounded-xl p-6">
                    ...
                    <form action="{{ route('employment-type.update', $employment_type->id) }}" method="POST">
                        @csrf
                        @method('PUT')

                        @include('setups.employment_types.input_fields', ['employment_type' => $employment_type])
