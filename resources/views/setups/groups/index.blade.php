    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <h3 class="text-2xl font-semibold text-gray-800">Group/Subject List</h3>
            ...
            <div class="overflow-x-auto border border-gray-200 rounded-lg">
                <table class="min-w-full bg-white text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @foreach ($groups as $key => $group)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <span class="font-semibold {{ $group->status ? 'text-green-600' : 'text-red-600' }}">
                        ...
                        @if ($groups->isEmpty())
                            <tr>
                                <td colspan="3" class="px-4 py-3 text-center text-gray-500">No groups available.</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
