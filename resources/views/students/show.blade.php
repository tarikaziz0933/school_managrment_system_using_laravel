    ...
    <div class="mt-10 bg-white p-10 rounded-lg shadow-lg max-w-5xl mx-auto text-sm leading-relaxed text-gray-800 font-sans">
        ...
        <div class="flex flex-col md:flex-row items-center md:items-start gap-6 border-b pb-6 mb-6">
            ...
            <div class="flex-1">
                ...
                <p class="text-gray-600">ID: {{ $student->id_number }} | Roll: {{ $student->roll }}</p>
                <p class="text-gray-600">Class: {{ $student->studentClass?->name }} | Section: {{ $student->section?->name }}</p>
                <p class="text-gray-600">Campus: {{ $student->campus?->name }}</p>
                <p class="text-gray-600">Date of Birth: {{ $student->dob?->format('d M, Y') }}</p>
            </div>
        </div>
