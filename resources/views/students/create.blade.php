            ...
            <div class="card-body">
                <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="w-full mt-4 flex">
                        <div class="flex-1">
                            <input type="date" id="dob" name="dob" class="mt-2 p-2 w-full border border-gray-300 rounded-md">
                        </div>
                    ...
                    <div class="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-3 w-full">
                            ...
                            <textarea id="prev_school" name="prev_school" placeholder="Enter Previous School's Name and Address"
                        ...
                        <div class="lg:col-span-3 w-full">
                            ...
                            <textarea id="present_address" name="present_address" placeholder="Enter Present Address"
                                class="mt-1 w-full text-lg border border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-blue-200 px-3 py-2 h-32"></textarea>
                        </div>
